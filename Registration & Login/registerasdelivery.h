...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Click += gcnew System::EventHandler(this, &registerasdelivery::button2_Click);
			// 
			// label1
			// 
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	//OOPFINALPROJECTSEMESTER2::deliverydashboard^ deliv = gcnew OOPFINALPROJECTSEMESTER2::deliverydashboard(textBox1->Text,textBox2->Text,textBox3->Text,textBox4->Text);
	//deliv->Show(); // Show MyForm1
	//this->Hide();
	String^ name = textBox1->Text;
	String^ email = textBox2->Text;
	String^ phoneno = textBox3->Text;
	...
	try {
		connect->Open();
		String^ query = "INSERT INTO loginasdelivery (username, password, address,email,phonenumber) VALUES (@name, @password, @address,@email,@phoneno)";
		...
		OOPFINALPROJECTSEMESTER2::deliverydashboard^ dash1 = gcnew OOPFINALPROJECTSEMESTER2::deliverydashboard(textBox1->Text, textBox2->Text, textBox3->Text, textBox4->Text);
